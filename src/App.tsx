                ...
                >
                    <Grid xs={12}>
                        ...
                        <Typography variant="h4"
                                    fontFamily="JetBrains Mono">{date.getFullYear()}/{(date.getMonth() + 1).toString().padStart(2, '0')}/{date.getDate().toString().padStart(2, '0')} ({days[date.getDay()]} #{Math.floor((date.getDate() + 6) / 7)})</Typography>
